...
pub use crate::code_editor::completer::Completer;
...
impl CodeEditor {
    pub fn id_source(self, id_source: impl Into<String>) -> Self {
        CodeEditor { id: id_source.into(), ..self }
    }
    ...
    pub fn with_numlines_shift(self, numlines_shift: isize) -> Self {
        CodeEditor { numlines_shift, ..self }
    }
    ...
    pub fn with_numlines_only_natural(self, numlines_only_natural: bool) -> Self {
        CodeEditor { numlines_only_natural, ..self }
    }
    ...
    pub fn desired_width(self, width: f32) -> Self {
        CodeEditor { desired_width: width, ..self }
    }
    ...
    pub fn stick_to_bottom(self, stick_to_bottom: bool) -> Self {
        CodeEditor { stick_to_bottom, ..self }
    }
    ...
    fn numlines_show(&self, ui: &mut egui::Ui, text: &str) {
        ...
        let width = max_indent as f32 * self.fontsize * 0.5 * !(total + self.numlines_shift <= 0 && self.numlines_only_natural) as u8 as f32;
        ...
        let mut layouter = |ui: &egui::Ui, text_buffer: &dyn TextBuffer, _wrap_width: f32| {
            let layout_job = egui::text::LayoutJob::single_section(
                ...
                egui::TextFormat::simple(egui::FontId::monospace(self.fontsize), self.theme.type_color(TokenType::Comment(true))),
            );
    ...
    pub fn show_with_completer(&mut self, ui: &mut egui::Ui, text: &mut dyn egui::TextBuffer, completer: &mut Completer) -> TextEditOutput {
    ...
    pub fn show(&mut self, ui: &mut egui::Ui, text: &mut dyn egui::TextBuffer) -> TextEditOutput {
        ...
        let mut code_editor = |ui: &mut egui::Ui| {
            ui.horizontal_top(|h| {
                ...
                egui::ScrollArea::horizontal().id_salt(format!("{}_inner_scroll", self.id)).show(h, |ui| {
                    let mut layouter = |ui: &egui::Ui, text_buffer: &dyn TextBuffer, _wrap_width: f32| {
