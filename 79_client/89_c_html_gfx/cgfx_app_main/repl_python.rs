...
use c_egui_base::{Cmsg_Full, Cmsg_Type, Cmsg_WwPython};
use e_api::wlog;
use e_api::*;
use egui::scroll_area::ScrollBarVisibility;
use egui::{PointerButton, ScrollArea, TextEdit};

pub struct Cgfx_Repl_Python {
    is_open: bool,
    language: String,
    code: String,
    text: String,
...
impl Cgfx_App_T for Cgfx_Repl_Python {
    ...
    fn update(&mut self, ui: &egui::Ui) {
        ...
        egui::Window::new(self.name())
            ...
            .show(ctx, |ui| {
                ...
                let theme =
      c_egui_base::egui_extras::syntax_highlighting::CodeTheme::from_memory(
        ui.ctx(),
        ui.style(),
      );
                ...
                ui.label("Python Output History:");
                ...
                if r.has_focus() {
                    if ui.input_mut(|i| {
                        ...
                        G_CmsgQ::send_oneshot(Cmsg_Inner::Ww_python(
                            Cmsg_WwPython::ReplEval {
...
impl Cgfx_Repl_Python {
    pub fn process_msg(&mut self, msg: Cmsg_Repl_Python) {
        match msg {
            Cmsg_Repl_Python::Output(x) => {
                self.repl.push(x);
            }
        }
    }
