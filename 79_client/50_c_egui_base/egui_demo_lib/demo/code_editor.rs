...
impl crate::egui_demo_lib::Demo for LispEditor {
...
impl crate::egui_demo_lib::View for LispEditor {
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        let mut layouter = |ui: &egui::Ui, buf: &dyn egui::TextBuffer, wrap_width: f32| {
            let mut layout_job = crate::egui_extras::syntax_highlighting::highlight(ui.ctx(), ui.style(), &theme, buf.as_str(), language);
