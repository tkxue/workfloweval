...
impl crate::egui_demo_lib::Demo for PopupsDemo {
...
impl crate::egui_demo_lib::View for PopupsDemo {
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        Frame::canvas(ui.style()).show(ui, |ui| {
            ...
            crate::egui_demo_lib::rust_view_ui(ui, "let align = RectAlign {");
            ui.horizontal(|ui| {
                crate::egui_demo_lib::rust_view_ui(ui, "    parent: Align2::");
                align_combobox(ui, "parent", &mut self.align4.parent);
                crate::egui_demo_lib::rust_view_ui(ui, ",");
            });
            ui.horizontal(|ui| {
                crate::egui_demo_lib::rust_view_ui(ui, "    child: Align2::");
            ...
            ui.horizontal(|ui| {
                crate::egui_demo_lib::rust_view_ui(ui, "let gap = ");
                ui.add(egui::DragValue::new(&mut self.gap));
                crate::egui_demo_lib::rust_view_ui(ui, ";");
            });

            crate::egui_demo_lib::rust_view_ui(ui, "let close_behavior");
            ui.horizontal(|ui| {
                crate::egui_demo_lib::rust_view_ui(ui, "    = PopupCloseBehavior::");
                let close_behaviors = [
                    (
            ...
            ui.horizontal(|ui| {
                crate::egui_demo_lib::rust_view_ui(ui, "let popup_open = ");
                ui.checkbox(&mut self.popup_open, "");
                crate::egui_demo_lib::rust_view_ui(ui, ";");
            });
            ui.monospace("");
            crate::egui_demo_lib::rust_view_ui(ui, "let response = ui.button(\"Click me!\");");
            crate::egui_demo_lib::rust_view_ui(ui, "Popup::menu(&response)");
            crate::egui_demo_lib::rust_view_ui(ui, "    .gap(gap).align(align)");
            crate::egui_demo_lib::rust_view_ui(ui, "    .close_behavior(close_behavior)");
            crate::egui_demo_lib::rust_view_ui(ui, "    .show(|ui| { /* menu contents */ });");
        });
