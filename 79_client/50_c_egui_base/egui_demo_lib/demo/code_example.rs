...
impl CodeExample {
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        ui.horizontal(|ui| {
            ...
            egui::Grid::new("code_samples").striped(true).num_columns(2).show(ui, |ui| {
                self.samples_in_grid(ui);
            });
        });

        // crate::egui_demo_lib::rust_crate_ui(ui, "    }\n}");
    }
}

impl crate::egui_demo_lib::Demo for CodeExample {
...
impl crate::egui_demo_lib::View for CodeExample {
    fn ui(&mut self, ui: &mut egui::Ui) {
        ui.scope(|ui| {
        ...
        // crate::egui_demo_lib::rust_crate_ui(ui, &format!("{self:#?}"));

        ui.separator();

        let mut theme = crate::egui_extras::syntax_highlighting::CodeTheme::from_memory(ui.ctx(), ui.style());
...
fn show_code(ui: &mut egui::Ui, code: &str) {
    ...
    // crate::egui_demo_lib::rust_crate_ui(ui, &code);
}
