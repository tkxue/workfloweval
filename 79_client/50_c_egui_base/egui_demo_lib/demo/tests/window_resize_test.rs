...
impl Default for WindowResizeTest {
    fn default() -> Self {
        Self {
            text: crate::egui_demo_lib::LOREM_IPSUM_LONG.to_owned(),
        }
    }
}

impl crate::egui_demo_lib::Demo for WindowResizeTest {
    ...
    fn show(&mut self, ctx: &egui::Context, open: &mut bool) {
        ...
        Window::new("↔ auto-sized")
            ...
            .show(ctx, |ui| {
                ...
                Resize::default().show(ui, |ui| {
                    lorem_ipsum(ui, crate::egui_demo_lib::LOREM_IPSUM);
                });
        ...
        Window::new("↔ resizable + scroll")
            ...
            .show(ctx, |ui| {
                ...
                ui.separator();
                lorem_ipsum(ui, crate::egui_demo_lib::LOREM_IPSUM_LONG);
            });
            ...
            .show(ctx, |ui| {
                ...
                ScrollArea::vertical().show(ui, |ui| {
                    let lorem_ipsum_extra_long = format!(
                        "{}\n\n{}",
                        crate::egui_demo_lib::LOREM_IPSUM_LONG,
                        crate::egui_demo_lib::LOREM_IPSUM_LONG
                    );
