...
impl crate::egui_demo_lib::Demo for Scrolling {
...
impl crate::egui_demo_lib::View for Scrolling {
        ...
        match self.demo {
            ...
            ScrollDemo::Bidirectional => {
                egui::ScrollArea::both().show(ui, |ui| {
                    ...
                    for _ in 0..100 {
                        ui.label(crate::egui_demo_lib::LOREM_IPSUM);
                    }
                });
            }
        }
                ...
                ui.with_layout(
                    ...
                    |ui| {
                        for _ in 0..*num_lorem_ipsums {
                            ui.label(crate::egui_demo_lib::LOREM_IPSUM_LONG);
                        }
                    },
                );
            });
...
impl crate::egui_demo_lib::View for ScrollTo {
    fn ui(&mut self, ui: &mut Ui) {
...
impl crate::egui_demo_lib::View for ScrollStickTo {
    fn ui(&mut self, ui: &mut Ui) {
