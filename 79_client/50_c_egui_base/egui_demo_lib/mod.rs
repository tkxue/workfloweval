...
pub mod counter;
pub mod resumee_search;
pub mod ssheet;

pub use demo::{Demo, View, WidgetGallery};
...
pub(crate) fn rust_view_ui(ui: &mut egui::Ui, code: &str) {
    let language = "rs";
    let theme = crate::egui_extras::syntax_highlighting::CodeTheme::from_memory(ui.ctx(), ui.style());
    crate::egui_extras::syntax_highlighting::code_view_ui(ui, &theme, code, language);
}
...
#[test]
fn test_egui_e2e() {
    let mut demo_windows = crate::egui_demo_lib::DemoWindows::default();
