use egui::{
    Pos2, Rangef, Rect, Shape, Stroke, Ui, UiBuilder, WidgetText, layers::ShapeIdx, pos2, vec2,
};

use super::{
    DirPosition, DragState, DropQuarter, IndentHintStyle, Input, Node, NodeConfig, NodeId, Output,
    TreeViewSettings, TreeViewState, UiData, node::NodeBuilder, rect_contains_visually,
};
