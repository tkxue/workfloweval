...
fn to_sizing(columns: &[Column]) -> crate::egui_extras::sizing::Sizing {
    use crate::egui_extras::Size;

    let mut sizing = crate::egui_extras::sizing::Sizing::default();
    ...
    pub fn col(&mut self, add_cell_contents: impl FnOnce(&mut Ui)) -> (Rect, Response) {
        ...
        let width = if let Some(width) = self.widths.get(col_index) {
            ...
            *width
            ...
            crate::egui_extras::log_or_panic!(
