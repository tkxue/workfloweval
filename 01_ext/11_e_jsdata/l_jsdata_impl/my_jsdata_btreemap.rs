...
impl<K: T_JsData_ + Hash + Eq + Ord, V: T_JsData_> T_JsData_ for BTreeMap<K, V> {
    #[inline(always)]
    ...
    #[inline(always)]
    fn read_from_js(reader: T_JsData_Read, _transfers: &mut VecDeque<wb::JsValue>) -> Result<BTreeMap<K, V>, L_JsData_Err> {
